...
*/
  ...
  async function handle(event){
    ...
    console.log(payload.get('cuisine')); 
    console.log(payload.get('zip1'));
    console.log(payload.get('zip2'));

    var zip1=payload.get('zip1');
    var zip2=payload.get('zip2');
    var cuisine=payload.get('cuisine');

    //local url : http://localhost:7071/api/dineTrigger
    ...
    const resp = await fetch (`/api/dineTrigger`, {
        method: 'POST',
